...
[← Previous: Operators & Expressions](unit-1-3-operators-expressions.md) | [Go back to TOC](../../README.md) | [Next: Conditionals →](../p2-control-structures-functions-tooling/unit-2-1-conditionals.md)
...
[← Previous:  Operators & Expressions](unit-1-3-operators-expressions.md) | [Go back to TOC](../../README.md) | [Next up: **Unit  — Conditionals** — where your programs make their first real decisions with `if`, `elif`, and `else`. →](../p2-control-structures-functions-tooling/unit-2-1-conditionals.md)
